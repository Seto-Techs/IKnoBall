...
export const mockTeamSeason: Game[] = [
  { id: 'season-1', homeTeam: 'Golden State Warriors', awayTeam: 'Houston Rockets', gameDateTime: day(1), status: 'Scheduled' },
  { id: 'season-2', homeTeam: 'Golden State Warriors', awayTeam: 'Phoenix Suns', gameDateTime: day(4), status: 'Scheduled' },
  { id: 'season-3', homeTeam: 'Denver Nuggets', awayTeam: 'Golden State Warriors', gameDateTime: day(7), status: 'Scheduled' },
  { id: 'season-4', homeTeam: 'Golden State Warriors', awayTeam: 'Dallas Mavericks', gameDateTime: day(10), status: 'Scheduled' },
  { id: 'season-5', homeTeam: 'Los Angeles Clippers', awayTeam: 'Golden State Warriors', gameDateTime: day(13), status: 'Scheduled' },
  { id: 'season-6', homeTeam: 'Golden State Warriors', awayTeam: 'Oklahoma City Thunder', gameDateTime: day(16), status: 'Scheduled' },
  { id: 'season-7', homeTeam: 'Memphis Grizzlies', awayTeam: 'Golden State Warriors', gameDateTime: day(19), status: 'Scheduled' },
  { id: 'season-8', homeTeam: 'Golden State Warriors', awayTeam: 'Sacramento Kings', gameDateTime: day(22), status: 'Scheduled' },
  { id: 'season-9', homeTeam: 'Golden State Warriors', awayTeam: 'Los Angeles Lakers', gameDateTime: day(25), status: 'Scheduled' },
  { id: 'season-10', homeTeam: 'Portland Trail Blazers', awayTeam: 'Golden State Warriors', gameDateTime: day(28), status: 'Scheduled' },
  { id: 'season-11', homeTeam: 'Golden State Warriors', awayTeam: 'Minnesota Timberwolves', gameDateTime: day(31), status: 'Scheduled' },
  { id: 'season-12', homeTeam: 'New Orleans Pelicans', awayTeam: 'Golden State Warriors', gameDateTime: day(34), status: 'Scheduled' },
  { id: 'season-13', homeTeam: 'Golden State Warriors', awayTeam: 'San Antonio Spurs', gameDateTime: day(37), status: 'Scheduled' },
  { id: 'season-14', homeTeam: 'Utah Jazz', awayTeam: 'Golden State Warriors', gameDateTime: day(40), status: 'Scheduled' },
  { id: 'season-15', homeTeam: 'Golden State Warriors', awayTeam: 'Houston Rockets', gameDateTime: day(43), status: 'Scheduled' },
  { id: 'season-16', homeTeam: 'Golden State Warriors', awayTeam: 'Phoenix Suns', gameDateTime: day(46), status: 'Scheduled' },
];

export const mockLeagueToday: Game[] = [
  { id: 'today-1', homeTeam: 'Golden State Warriors', awayTeam: 'Los Angeles Lakers', homeScore: 102, awayScore: 98, gameDateTime: day(0), status: 'Live' },
  { id: 'today-2', homeTeam: 'Boston Celtics', awayTeam: 'Miami Heat', homeScore: null, awayScore: null, gameDateTime: day(0), status: 'Scheduled' },
  { id: 'today-3', homeTeam: 'Milwaukee Bucks', awayTeam: 'New York Knicks', homeScore: null, awayScore: null, gameDateTime: day(0), status: 'Scheduled' },
  { id: 'today-4', homeTeam: 'Denver Nuggets', awayTeam: 'Oklahoma City Thunder', homeScore: null, awayScore: null, gameDateTime: day(0), status: 'Scheduled' },
  { id: 'today-5', homeTeam: 'Cleveland Cavaliers', awayTeam: 'Philadelphia 76ers', homeScore: null, awayScore: null, gameDateTime: day(0), status: 'Scheduled' },
  { id: 'today-6', homeTeam: 'Dallas Mavericks', awayTeam: 'Minnesota Timberwolves', homeScore: null, awayScore: null, gameDateTime: day(0), status: 'Scheduled' },
  { id: 'today-7', homeTeam: 'Phoenix Suns', awayTeam: 'Los Angeles Clippers', homeScore: null, awayScore: null, gameDateTime: day(0), status: 'Scheduled' },
];
